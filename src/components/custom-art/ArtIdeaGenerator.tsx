...
import {
  generateArtIdeas,
  type GenerateArtIdeasInput,
  type GenerateArtIdeasOutput,
} from "@/ai/flows/generate-art-ideas";
  ...
  const handleSubmit = async (event: FormEvent) => {
    ...
    if (!description.trim()) {
      toast({
        ...
        description: "Please describe your art idea.",
        variant: "destructive",
      });
      return;
    }
    ...
    try {
      ...
      toast({
        ...
        description: "Check out the AI-powered suggestions below.",
        variant: "success",
      });
    } catch (error) {
      ...
      toast({
        title: "Error",
        description: "Failed to generate art ideas. Please try again.",
        variant: "destructive",
      });
    } finally {
      setIsLoading(false);
    ...
    <Card className="shadow-lg">
      <CardHeader>
        <CardTitle className="font-headline text-2xl flex items-center">
          <Sparkles className="mr-2 h-6 w-6 text-accent" /> AI Art Idea
          Generator
        </CardTitle>
        <CardDescription>
      ...
      <CardContent>
        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            <Label htmlFor="ideaDescription" className="font-semibold">
              Art Description
            </Label>
            <Textarea
              id="ideaDescription"
          ...
          <div>
            <Label htmlFor="ideaImage" className="font-semibold">
