...
export default function CheckoutPage() {
  ...
  const onSubmit: SubmitHandler<CheckoutFormValues> = (data) => {
    ...
    toast({
      ...
      description:
        "Your order has been successfully placed. Thank you for shopping with ArtsyCraftsy!",
      variant: "success",
    });
    clearCart();
  ...
  return (
    <div className="max-w-2xl mx-auto">
      <Card className="shadow-xl">
        <CardHeader>
          <CardTitle className="font-headline text-2xl sm:text-3xl text-center">
            Checkout
          </CardTitle>
        </CardHeader>
        <CardContent>
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
              <section>
                <h2 className="font-headline text-lg sm:text-xl mb-3">
