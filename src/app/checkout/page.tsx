...
export default function CheckoutPage() {
  ...
  const handlePayment = async (data: CheckoutFormValues) => {
    ...
    try {
      // 1. Call your custom order creation API
      const orderPayload = {
      ...
      // 2. Extract Razorpay order details from your backend's response
      ...
      const options = {
        ...
        handler: async function (response: any) {
          ...
          if (verificationResponse.ok && verificationResult.status === 1) {
            ...
            throw new Error(verificationResult.message || "Payment failed.");
          }
        },
        prefill: {
